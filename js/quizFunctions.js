//edit: rhys_rob - add image option to questions
...
function loadTextQuestion(quiz, qNumber){
	...
	if(quiz['question'][2]){
		var questionImage ="<div class='qImage'><img src='"+quiz['question'][2]+"'></div>";
	} else {
		var questionImage = "";
	}
	...
	var html = "<div class='question' data-id='"+qNumber+"'>"+questionNumber+question+questionImage+answer+button+"</div>";
...
function loadRadioImages(quiz, qNumber){
	var questionNumber = "<h2 class='qNumber'><span>Q</span>"+qNumber+"</h2>";
	...
	var answer = "<div class='qAnswerImages'";
	if(quiz['answer_style']){
		answer += "style='"+quiz['answer_style']+"'";
	}else{
		answer += ">";
	...
	$.each(quiz['possible_answers'], function(a, ans){
		...
		answer += "<label> \
		<input type='radio' name='q"+qNumber+"' value='"+i+"' data-correct='"+ans['answer']+"' id='radio_q"+qNumber+"_r"+i+"'> \
		<img src="+ans['answer_text']+" /> \
		</label>";
...
function loadMultiImages(quiz, qNumber){
	var questionNumber = "<h2 class='qNumber'><span>Q</span>"+qNumber+"</h2>";
	...
	var answer = "<div class='qAnswer qAnswerImages' data-max='"+quiz['maxSelect']+"'";
	if(quiz['answer_style']){
		answer += "style='"+quiz['answer_style']+"'";
	}else{
		answer += ">";
	...
	$.each(quiz['possible_answers'], function(a, ans){
		...
		answer += "<label> \
		<input type='checkbox' name='q"+qNumber+"' value='"+i+"' data-correct='"+ans['answer']+"' id='check_q"+qNumber+"_r"+i+"'> \
		<img src="+ans['answer_text']+" /> \
		</label>";
	...
	$.each(quiz, function(qz, quiz){
		...
		switch(quiz['type']){
			...
			case 4:
				...
				break;
			case 5:
				loadRadioImages(quiz, i);
				break;
			case 6:
				loadMultiImages(quiz, i);		
		}
	});
}
